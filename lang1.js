document.addEventListener('DOMContentLoaded', function () {
    ...
    function cambiarIdioma() {
        ...
        enlaces.textContent = traducciones[idiomaSeleccionado].enlaces;
        correo.textContent = traducciones[idiomaSeleccionado].correo;
        inicio.innerHTML = `<a class="nav-link py-3 px-0 px-lg-3 rounded" href="#">${traducciones[idiomaSeleccionado].inicio}</a>`;
        acerca.innerHTML = `<a class="nav-link py-3 px-0 px-lg-3 rounded" href="about.html">${traducciones[idiomaSeleccionado].acerca}</a>`;
        proyectos.innerHTML = `<a class="nav-link py-3 px-0 px-lg-3 rounded" href="#">${traducciones[idiomaSeleccionado].proyectos}</a>`;
        intereses.innerHTML = `<a class="nav-link py-3 px-0 px-lg-3 rounded" href="#">${traducciones[idiomaSeleccionado].intereses}</a>`;
        contacto.innerHTML = `<a class="nav-link py-3 px-0 px-lg-3 rounded" href="#">${traducciones[idiomaSeleccionado].contacto}</a>`;
    }
