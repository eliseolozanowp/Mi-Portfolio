...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function cambiarIdioma() {
        ...
        if (tecnologias) tecnologias.textContent = traducciones[idiomaSeleccionado].tecnologias;
        if (back) back.textContent = traducciones[idiomaSeleccionado].back;
        if (next) next.textContent = traducciones[idiomaSeleccionado].next;
